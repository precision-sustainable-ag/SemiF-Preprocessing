...
class YOLO:
    ...
    def __init__(self, save_dir=None, batch_name= None, model='yolov8n.yaml', type="v8") -> None:
        """
    ...
    def predict(self, source=None, stream=False, **kwargs):
        ...
        if is_cli:
            ...
            return self.predictor(source=source, stream=stream, batch_name=self.batch_name, save_dir=Path(self.save_dir))
        # return self.predictor.predict_cli(source=source) if is_cli else self.predictor(source=source, stream=stream, batch_name=self.batch_name)
